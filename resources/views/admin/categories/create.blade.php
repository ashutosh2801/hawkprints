...
<form action="/admin/categories" method="POST" enctype="multipart/form-data" class="max-w-2xl">
    ...
    <div class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="meta_title" class="w-full px-4 py-2 border border-gray-300 rounded-lg" placeholder="Category name - {{ \App\Models\Setting::get('company_name', 'Five Rivers Print') }}">
            <small class="text-gray-500">Recommended: 50-60 characters. Leave blank to use category name.</small>
        </div>

        <div class="mt-4">
            <label class="block text-sm font-medium text-gray-700 mb-1">Meta Description</label>
            <textarea name="meta_description" rows="3" maxlength="160" class="w-full px-4 py-2 border border-gray-300 rounded-lg" placeholder="Brief description of this category..."></textarea>
