...
<form action="/admin/testimonials/{{ $testimonial->id }}" method="POST" enctype="multipart/form-data" class="max-w-2xl">
    ...
    <div class="space-y-4">
        ...
        <div>
            ...
            <textarea name="message" rows="4" required class="w-full px-4 py-2 border border-gray-300 rounded-lg">{{ $testimonial->message }}</textarea>
        </div>
        ...
        <div>
            ...
            <div class="mb-2">
                <img src="{{ $testimonial->avatar }}" alt="" class="w-16 h-16 rounded-full object-cover">
            </div>
            @endif
