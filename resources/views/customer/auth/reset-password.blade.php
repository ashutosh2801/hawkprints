...
@section('title', 'Reset Password - Five Rivers Print')
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-md mx-auto bg-white rounded-lg shadow-md overflow-hidden">
            <div class="bg-blue-700 text-white p-6 text-center">
                ...
                <p class="text-blue-100 mt-1">Create a new password for your account</p>
            </div>

            <form method="POST" action="{{ route('customer.password.update') }}" class="p-8">
                @csrf
